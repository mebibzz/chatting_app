...
<body>
	...
	<div id="footer">
			<div id="devlopername">
				<h2>Powered By</h2>
				<h3><a href="https://twitter.com/me_bibzz" target="_blank">Biplab Mandal</a></h3>
				<ul>
					<li><a href="https://www.facebook.com/biplab3222" target="_blank"><i class="fa fa-facebook fa-1x" aria-hidden="true"></i></a></li>
					<li><a href="https://www.instagram.com/me_bibz/" target="_blank"><i class="fa fa-instagram fa-1x" aria-hidden="true"></i></a></li>
					<li><a href="https://github.com/mebibzz" target="_blank"><i class="fa fa-github fa-1x" aria-hidden="true"></i></a></li>
				</ul>					
			</div>
		</div>
	</div>
